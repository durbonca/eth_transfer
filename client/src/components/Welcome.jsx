...
const commonStyle =
  'min-h-[70px] sm:px-0 px-2 sm:min-w-[120px] flex justify-center items-center border-[0.5px] border-gray-400 text-white font-light';
...
const Welcome = () => {
  const { connectWallet, currentAccount, formData, sendTransaction, handleChange, isLoading } = useContext(
    TransactionContext,
  );
  ...
  return (
    <div className="flex w-full justify-center items-center">
      <div className="flex flex-col mf:flex-row justify-between mf:p-20 py-12 px-4 items-start">
        <div className="flex flex-1 justify-start flex-col md:mr-10">
          ...
          <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
            ...
            <div className={`rounded-bl-2xl ${commonStyle}`}>Web3.0</div>
          ...
          <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
            ...
            {isLoading ? (
              ...
              <button
                ...
                className="text-white w-full mt-2 border-[1px] p-2 border-[#3d4f7c] rounded-full cursor-pointer bg-[#3d4f7c] hover:bg-[#394f86] text-sm font-semibold"
              >
                Send Now
              </button>
            )}
